 ...
 *
 */
public final class FLACAudioDecoder {
	...
	private static FLACAudioDecoder handler = null;
	...
	/**
	 * test if initialization has completed.
	 * 
	 * @return
	 */
	public static Boolean ifFLACDecoderInitialized() {
		if (isReady) {
			return true;
		} else {
			return false;
	...
	public static FLACAudioDecoder getInstance() {
		return handler;
	}
	...
	public static Boolean makeInstance(Path songPath) throws IOException,
			BadFileFormatException {
		handler = null;
		handler = new FLACAudioDecoder(songPath);
		if (handler != null) {
			return true;
		} else {
			return false;
	...
	private FLACAudioDecoder(Path songPath) throws IOException,
			BadFileFormatException {
